...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,jobId,pickupAddress,dropoffAddress,pickupAddressDetail,dropoffAddressDetail,pickupDistanceKm,dropoffDistanceKm,pickupLat,pickupLng,dropoffLat,dropoffLng,netIncome,paymentMethod,points,serviceType,passengerName,itemSummary,timeoutSeconds);

@override
String toString() {
  return 'IncomingJobModel(jobId: $jobId, pickupAddress: $pickupAddress, dropoffAddress: $dropoffAddress, pickupAddressDetail: $pickupAddressDetail, dropoffAddressDetail: $dropoffAddressDetail, pickupDistanceKm: $pickupDistanceKm, dropoffDistanceKm: $dropoffDistanceKm, pickupLat: $pickupLat, pickupLng: $pickupLng, dropoffLat: $dropoffLat, dropoffLng: $dropoffLng, netIncome: $netIncome, paymentMethod: $paymentMethod, points: $points, serviceType: $serviceType, passengerName: $passengerName, itemSummary: $itemSummary, timeoutSeconds: $timeoutSeconds)';
}
