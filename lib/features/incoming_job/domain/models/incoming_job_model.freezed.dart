...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,jobId,pickupAddress,dropoffAddress,pickupAddressDetail,dropoffAddressDetail,pickupDistanceKm,dropoffDistanceKm,pickupLat,pickupLng,dropoffLat,dropoffLng,netIncome,paymentMethod,points,serviceType,passengerName,itemSummary,timeoutSeconds,surgeMultiplier,surgeActive,isScheduled,scheduledAt,restaurantName,deliveryFee,subtotal,const DeepCollectionEquality().hash(orderItems)]);
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,jobId,pickupAddress,dropoffAddress,pickupAddressDetail,dropoffAddressDetail,pickupDistanceKm,dropoffDistanceKm,pickupLat,pickupLng,dropoffLat,dropoffLng,netIncome,paymentMethod,points,serviceType,passengerName,itemSummary,timeoutSeconds,surgeMultiplier,surgeActive,isScheduled,scheduledAt,restaurantName,deliveryFee,subtotal,const DeepCollectionEquality().hash(_orderItems)]);
