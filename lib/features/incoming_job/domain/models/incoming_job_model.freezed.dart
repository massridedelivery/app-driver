...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,jobId,pickupAddress,dropoffAddress,pickupAddressDetail,dropoffAddressDetail,pickupDistanceKm,dropoffDistanceKm,distanceKm,pickupLat,pickupLng,dropoffLat,dropoffLng,netIncome,paymentMethod,points,serviceType,passengerName,passengerPhone,itemSummary,timeoutSeconds,surgeMultiplier,surgeActive,isScheduled,scheduledAt,restaurantName,deliveryFee,subtotal,const DeepCollectionEquality().hash(orderItems)]);

@override
String toString() {
  return 'IncomingJobModel(jobId: $jobId, pickupAddress: $pickupAddress, dropoffAddress: $dropoffAddress, pickupAddressDetail: $pickupAddressDetail, dropoffAddressDetail: $dropoffAddressDetail, pickupDistanceKm: $pickupDistanceKm, dropoffDistanceKm: $dropoffDistanceKm, distanceKm: $distanceKm, pickupLat: $pickupLat, pickupLng: $pickupLng, dropoffLat: $dropoffLat, dropoffLng: $dropoffLng, netIncome: $netIncome, paymentMethod: $paymentMethod, points: $points, serviceType: $serviceType, passengerName: $passengerName, passengerPhone: $passengerPhone, itemSummary: $itemSummary, timeoutSeconds: $timeoutSeconds, surgeMultiplier: $surgeMultiplier, surgeActive: $surgeActive, isScheduled: $isScheduled, scheduledAt: $scheduledAt, restaurantName: $restaurantName, deliveryFee: $deliveryFee, subtotal: $subtotal, orderItems: $orderItems)';
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,jobId,pickupAddress,dropoffAddress,pickupAddressDetail,dropoffAddressDetail,pickupDistanceKm,dropoffDistanceKm,distanceKm,pickupLat,pickupLng,dropoffLat,dropoffLng,netIncome,paymentMethod,points,serviceType,passengerName,passengerPhone,itemSummary,timeoutSeconds,surgeMultiplier,surgeActive,isScheduled,scheduledAt,restaurantName,deliveryFee,subtotal,const DeepCollectionEquality().hash(_orderItems)]);
