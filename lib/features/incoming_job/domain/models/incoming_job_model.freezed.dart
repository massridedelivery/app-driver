...
@JsonKey(name: 'id') String get jobId;@JsonKey(name: 'pickup_address') String get pickupAddress;@JsonKey(name: 'dropoff_address') String get dropoffAddress;@JsonKey(name: 'pickup_address_detail') String get pickupAddressDetail;@JsonKey(name: 'dropoff_address_detail') String get dropoffAddressDetail;@JsonKey(name: 'pickup_distance_km') double get pickupDistanceKm;@JsonKey(name: 'dropoff_distance_km') double get dropoffDistanceKm;@JsonKey(name: 'distance_km') double? get distanceKm;@JsonKey(name: 'pickup_lat') double get pickupLat;@JsonKey(name: 'pickup_lng') double get pickupLng;@JsonKey(name: 'dropoff_lat') double get dropoffLat;@JsonKey(name: 'dropoff_lng') double get dropoffLng;@JsonKey(name: 'encoded_polyline', readValue: readPolyline) String? get encodedPolyline;@JsonKey(name: 'fare') double get netIncome;// Amount the driver must actually COLLECT at the end (fare + tolls + waiting
// that accrued en route) — distinct from the display `fare`. Collecting
// `fare` under-charges (SCRUM-86 §6). Null until BE ships it.
@JsonKey(name: 'amount_due') double? get amountDue;@JsonKey(name: 'payment_method') String get paymentMethod;@JsonKey(name: 'points') int get points;@JsonKey(name: 'service_type') String get serviceType;@JsonKey(name: 'passenger_name', readValue: readCustomerName) String get passengerName;// Customer phone for the in-trip "call" button. Backend sends it either flat
// (passenger_phone) or nested under customer.phone (JobCustomerInfo).
@JsonKey(name: 'passenger_phone', readValue: readCustomerPhone) String get passengerPhone;@JsonKey(name: 'item_summary') String get itemSummary;@JsonKey(name: 'timeout_seconds') int get timeoutSeconds;@JsonKey(name: 'surge_multiplier') double get surgeMultiplier;@JsonKey(name: 'surge_active') bool get surgeActive;@JsonKey(name: 'is_scheduled') bool get isScheduled;@JsonKey(name: 'scheduled_at') String? get scheduledAt;// Food Delivery fields
@JsonKey(name: 'restaurant_name') String? get restaurantName;@JsonKey(name: 'delivery_fee') double get deliveryFee;@JsonKey(name: 'subtotal') double get subtotal;@JsonKey(name: 'order_items') List<Map<String, dynamic>> get orderItems;
...
@useResult
$Res call({
@JsonKey(name: 'id') String jobId,@JsonKey(name: 'pickup_address') String pickupAddress,@JsonKey(name: 'dropoff_address') String dropoffAddress,@JsonKey(name: 'pickup_address_detail') String pickupAddressDetail,@JsonKey(name: 'dropoff_address_detail') String dropoffAddressDetail,@JsonKey(name: 'pickup_distance_km') double pickupDistanceKm,@JsonKey(name: 'dropoff_distance_km') double dropoffDistanceKm,@JsonKey(name: 'distance_km') double? distanceKm,@JsonKey(name: 'pickup_lat') double pickupLat,@JsonKey(name: 'pickup_lng') double pickupLng,@JsonKey(name: 'dropoff_lat') double dropoffLat,@JsonKey(name: 'dropoff_lng') double dropoffLng,@JsonKey(name: 'encoded_polyline', readValue: readPolyline) String? encodedPolyline,@JsonKey(name: 'fare') double netIncome,@JsonKey(name: 'amount_due') double? amountDue,@JsonKey(name: 'payment_method') String paymentMethod,@JsonKey(name: 'points') int points,@JsonKey(name: 'service_type') String serviceType,@JsonKey(name: 'passenger_name', readValue: readCustomerName) String passengerName,@JsonKey(name: 'passenger_phone', readValue: readCustomerPhone) String passengerPhone,@JsonKey(name: 'item_summary') String itemSummary,@JsonKey(name: 'timeout_seconds') int timeoutSeconds,@JsonKey(name: 'surge_multiplier') double surgeMultiplier,@JsonKey(name: 'surge_active') bool surgeActive,@JsonKey(name: 'is_scheduled') bool isScheduled,@JsonKey(name: 'scheduled_at') String? scheduledAt,@JsonKey(name: 'restaurant_name') String? restaurantName,@JsonKey(name: 'delivery_fee') double deliveryFee,@JsonKey(name: 'subtotal') double subtotal,@JsonKey(name: 'order_items') List<Map<String, dynamic>> orderItems
});
...
/// Create a copy of IncomingJobModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? jobId = null,Object? pickupAddress = null,Object? dropoffAddress = null,Object? pickupAddressDetail = null,Object? dropoffAddressDetail = null,Object? pickupDistanceKm = null,Object? dropoffDistanceKm = null,Object? distanceKm = freezed,Object? pickupLat = null,Object? pickupLng = null,Object? dropoffLat = null,Object? dropoffLng = null,Object? encodedPolyline = freezed,Object? netIncome = null,Object? amountDue = freezed,Object? paymentMethod = null,Object? points = null,Object? serviceType = null,Object? passengerName = null,Object? passengerPhone = null,Object? itemSummary = null,Object? timeoutSeconds = null,Object? surgeMultiplier = null,Object? surgeActive = null,Object? isScheduled = null,Object? scheduledAt = freezed,Object? restaurantName = freezed,Object? deliveryFee = null,Object? subtotal = null,Object? orderItems = null,}) {
...
as double,encodedPolyline: freezed == encodedPolyline ? _self.encodedPolyline : encodedPolyline // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String jobId, @JsonKey(name: 'pickup_address')  String pickupAddress, @JsonKey(name: 'dropoff_address')  String dropoffAddress, @JsonKey(name: 'pickup_address_detail')  String pickupAddressDetail, @JsonKey(name: 'dropoff_address_detail')  String dropoffAddressDetail, @JsonKey(name: 'pickup_distance_km')  double pickupDistanceKm, @JsonKey(name: 'dropoff_distance_km')  double dropoffDistanceKm, @JsonKey(name: 'distance_km')  double? distanceKm, @JsonKey(name: 'pickup_lat')  double pickupLat, @JsonKey(name: 'pickup_lng')  double pickupLng, @JsonKey(name: 'dropoff_lat')  double dropoffLat, @JsonKey(name: 'dropoff_lng')  double dropoffLng, @JsonKey(name: 'encoded_polyline', readValue: readPolyline)  String? encodedPolyline, @JsonKey(name: 'fare')  double netIncome, @JsonKey(name: 'amount_due')  double? amountDue, @JsonKey(name: 'payment_method')  String paymentMethod, @JsonKey(name: 'points')  int points, @JsonKey(name: 'service_type')  String serviceType, @JsonKey(name: 'passenger_name', readValue: readCustomerName)  String passengerName, @JsonKey(name: 'passenger_phone', readValue: readCustomerPhone)  String passengerPhone, @JsonKey(name: 'item_summary')  String itemSummary, @JsonKey(name: 'timeout_seconds')  int timeoutSeconds, @JsonKey(name: 'surge_multiplier')  double surgeMultiplier, @JsonKey(name: 'surge_active')  bool surgeActive, @JsonKey(name: 'is_scheduled')  bool isScheduled, @JsonKey(name: 'scheduled_at')  String? scheduledAt, @JsonKey(name: 'restaurant_name')  String? restaurantName, @JsonKey(name: 'delivery_fee')  double deliveryFee, @JsonKey(name: 'subtotal')  double subtotal, @JsonKey(name: 'order_items')  List<Map<String, dynamic>> orderItems)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _IncomingJobModel() when $default != null:
return $default(_that.jobId,_that.pickupAddress,_that.dropoffAddress,_that.pickupAddressDetail,_that.dropoffAddressDetail,_that.pickupDistanceKm,_that.dropoffDistanceKm,_that.distanceKm,_that.pickupLat,_that.pickupLng,_that.dropoffLat,_that.dropoffLng,_that.encodedPolyline,_that.netIncome,_that.amountDue,_that.paymentMethod,_that.points,_that.serviceType,_that.passengerName,_that.passengerPhone,_that.itemSummary,_that.timeoutSeconds,_that.surgeMultiplier,_that.surgeActive,_that.isScheduled,_that.scheduledAt,_that.restaurantName,_that.deliveryFee,_that.subtotal,_that.orderItems);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'id')  String jobId, @JsonKey(name: 'pickup_address')  String pickupAddress, @JsonKey(name: 'dropoff_address')  String dropoffAddress, @JsonKey(name: 'pickup_address_detail')  String pickupAddressDetail, @JsonKey(name: 'dropoff_address_detail')  String dropoffAddressDetail, @JsonKey(name: 'pickup_distance_km')  double pickupDistanceKm, @JsonKey(name: 'dropoff_distance_km')  double dropoffDistanceKm, @JsonKey(name: 'distance_km')  double? distanceKm, @JsonKey(name: 'pickup_lat')  double pickupLat, @JsonKey(name: 'pickup_lng')  double pickupLng, @JsonKey(name: 'dropoff_lat')  double dropoffLat, @JsonKey(name: 'dropoff_lng')  double dropoffLng, @JsonKey(name: 'encoded_polyline', readValue: readPolyline)  String? encodedPolyline, @JsonKey(name: 'fare')  double netIncome, @JsonKey(name: 'amount_due')  double? amountDue, @JsonKey(name: 'payment_method')  String paymentMethod, @JsonKey(name: 'points')  int points, @JsonKey(name: 'service_type')  String serviceType, @JsonKey(name: 'passenger_name', readValue: readCustomerName)  String passengerName, @JsonKey(name: 'passenger_phone', readValue: readCustomerPhone)  String passengerPhone, @JsonKey(name: 'item_summary')  String itemSummary, @JsonKey(name: 'timeout_seconds')  int timeoutSeconds, @JsonKey(name: 'surge_multiplier')  double surgeMultiplier, @JsonKey(name: 'surge_active')  bool surgeActive, @JsonKey(name: 'is_scheduled')  bool isScheduled, @JsonKey(name: 'scheduled_at')  String? scheduledAt, @JsonKey(name: 'restaurant_name')  String? restaurantName, @JsonKey(name: 'delivery_fee')  double deliveryFee, @JsonKey(name: 'subtotal')  double subtotal, @JsonKey(name: 'order_items')  List<Map<String, dynamic>> orderItems)  $default,) {final _that = this;
switch (_that) {
case _IncomingJobModel():
return $default(_that.jobId,_that.pickupAddress,_that.dropoffAddress,_that.pickupAddressDetail,_that.dropoffAddressDetail,_that.pickupDistanceKm,_that.dropoffDistanceKm,_that.distanceKm,_that.pickupLat,_that.pickupLng,_that.dropoffLat,_that.dropoffLng,_that.encodedPolyline,_that.netIncome,_that.amountDue,_that.paymentMethod,_that.points,_that.serviceType,_that.passengerName,_that.passengerPhone,_that.itemSummary,_that.timeoutSeconds,_that.surgeMultiplier,_that.surgeActive,_that.isScheduled,_that.scheduledAt,_that.restaurantName,_that.deliveryFee,_that.subtotal,_that.orderItems);}
}
...
class _IncomingJobModel extends IncomingJobModel {
  const _IncomingJobModel({@JsonKey(name: 'id') required this.jobId, @JsonKey(name: 'pickup_address') required this.pickupAddress, @JsonKey(name: 'dropoff_address') required this.dropoffAddress, @JsonKey(name: 'pickup_address_detail') this.pickupAddressDetail = '', @JsonKey(name: 'dropoff_address_detail') this.dropoffAddressDetail = '', @JsonKey(name: 'pickup_distance_km') this.pickupDistanceKm = 0.0, @JsonKey(name: 'dropoff_distance_km') this.dropoffDistanceKm = 0.0, @JsonKey(name: 'distance_km') this.distanceKm, @JsonKey(name: 'pickup_lat') required this.pickupLat, @JsonKey(name: 'pickup_lng') required this.pickupLng, @JsonKey(name: 'dropoff_lat') required this.dropoffLat, @JsonKey(name: 'dropoff_lng') required this.dropoffLng, @JsonKey(name: 'encoded_polyline', readValue: readPolyline) this.encodedPolyline, @JsonKey(name: 'fare') required this.netIncome, @JsonKey(name: 'amount_due') this.amountDue, @JsonKey(name: 'payment_method') required this.paymentMethod, @JsonKey(name: 'points') this.points = 0, @JsonKey(name: 'service_type') this.serviceType = 'Saver Bike', @JsonKey(name: 'passenger_name', readValue: readCustomerName) this.passengerName = 'Passenger', @JsonKey(name: 'passenger_phone', readValue: readCustomerPhone) this.passengerPhone = '', @JsonKey(name: 'item_summary') this.itemSummary = '', @JsonKey(name: 'timeout_seconds') this.timeoutSeconds = 16, @JsonKey(name: 'surge_multiplier') this.surgeMultiplier = 1.0, @JsonKey(name: 'surge_active') this.surgeActive = false, @JsonKey(name: 'is_scheduled') this.isScheduled = false, @JsonKey(name: 'scheduled_at') this.scheduledAt, @JsonKey(name: 'restaurant_name') this.restaurantName, @JsonKey(name: 'delivery_fee') this.deliveryFee = 0.0, @JsonKey(name: 'subtotal') this.subtotal = 0.0, @JsonKey(name: 'order_items') final  List<Map<String, dynamic>> orderItems = const []}): _orderItems = orderItems,super._();
...
@override@JsonKey(name: 'encoded_polyline', readValue: readPolyline) final  String? encodedPolyline;
@override@JsonKey(name: 'fare') final  double netIncome;
// Amount the driver must actually COLLECT at the end (fare + tolls + waiting
// that accrued en route) — distinct from the display `fare`. Collecting
// `fare` under-charges (SCRUM-86 §6). Null until BE ships it.
@override@JsonKey(name: 'amount_due') final  double? amountDue;
@override@JsonKey(name: 'payment_method') final  String paymentMethod;
@override@JsonKey(name: 'points') final  int points;
@override@JsonKey(name: 'service_type') final  String serviceType;
@override@JsonKey(name: 'passenger_name', readValue: readCustomerName) final  String passengerName;
// Customer phone for the in-trip "call" button. Backend sends it either flat
// (passenger_phone) or nested under customer.phone (JobCustomerInfo).
@override@JsonKey(name: 'passenger_phone', readValue: readCustomerPhone) final  String passengerPhone;
...
@override@JsonKey(name: 'order_items') List<Map<String, dynamic>> get orderItems {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _IncomingJobModel&&(identical(other.jobId, jobId) || other.jobId == jobId)&&(identical(other.pickupAddress, pickupAddress) || other.pickupAddress == pickupAddress)&&(identical(other.dropoffAddress, dropoffAddress) || other.dropoffAddress == dropoffAddress)&&(identical(other.pickupAddressDetail, pickupAddressDetail) || other.pickupAddressDetail == pickupAddressDetail)&&(identical(other.dropoffAddressDetail, dropoffAddressDetail) || other.dropoffAddressDetail == dropoffAddressDetail)&&(identical(other.pickupDistanceKm, pickupDistanceKm) || other.pickupDistanceKm == pickupDistanceKm)&&(identical(other.dropoffDistanceKm, dropoffDistanceKm) || other.dropoffDistanceKm == dropoffDistanceKm)&&(identical(other.distanceKm, distanceKm) || other.distanceKm == distanceKm)&&(identical(other.pickupLat, pickupLat) || other.pickupLat == pickupLat)&&(identical(other.pickupLng, pickupLng) || other.pickupLng == pickupLng)&&(identical(other.dropoffLat, dropoffLat) || other.dropoffLat == dropoffLat)&&(identical(other.dropoffLng, dropoffLng) || other.dropoffLng == dropoffLng)&&(identical(other.encodedPolyline, encodedPolyline) || other.encodedPolyline == encodedPolyline)&&(identical(other.netIncome, netIncome) || other.netIncome == netIncome)&&(identical(other.amountDue, amountDue) || other.amountDue == amountDue)&&(identical(other.paymentMethod, paymentMethod) || other.paymentMethod == paymentMethod)&&(identical(other.points, points) || other.points == points)&&(identical(other.serviceType, serviceType) || other.serviceType == serviceType)&&(identical(other.passengerName, passengerName) || other.passengerName == passengerName)&&(identical(other.passengerPhone, passengerPhone) || other.passengerPhone == passengerPhone)&&(identical(other.itemSummary, itemSummary) || other.itemSummary == itemSummary)&&(identical(other.timeoutSeconds, timeoutSeconds) || other.timeoutSeconds == timeoutSeconds)&&(identical(other.surgeMultiplier, surgeMultiplier) || other.surgeMultiplier == surgeMultiplier)&&(identical(other.surgeActive, surgeActive) || other.surgeActive == surgeActive)&&(identical(other.isScheduled, isScheduled) || other.isScheduled == isScheduled)&&(identical(other.scheduledAt, scheduledAt) || other.scheduledAt == scheduledAt)&&(identical(other.restaurantName, restaurantName) || other.restaurantName == restaurantName)&&(identical(other.deliveryFee, deliveryFee) || other.deliveryFee == deliveryFee)&&(identical(other.subtotal, subtotal) || other.subtotal == subtotal)&&const DeepCollectionEquality().equals(other._orderItems, _orderItems));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,jobId,pickupAddress,dropoffAddress,pickupAddressDetail,dropoffAddressDetail,pickupDistanceKm,dropoffDistanceKm,distanceKm,pickupLat,pickupLng,dropoffLat,dropoffLng,encodedPolyline,netIncome,amountDue,paymentMethod,points,serviceType,passengerName,passengerPhone,itemSummary,timeoutSeconds,surgeMultiplier,surgeActive,isScheduled,scheduledAt,restaurantName,deliveryFee,subtotal,const DeepCollectionEquality().hash(_orderItems)]);
