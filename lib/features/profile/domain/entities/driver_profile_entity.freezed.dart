...
@useResult
$Res call({
@JsonKey(name: 'user_id') String userId,@JsonKey(name: 'full_name') String fullName, String? phone, double rating,@JsonKey(name: 'total_trips') int totalTrips, bool verified, List<DocumentEntity> documents,@JsonKey(name: 'vehicle_type_ids') List<String> vehicleTypeIds,@JsonKey(name: 'vehicle_types') List<VehicleTypeEntity> vehicleTypes,@JsonKey(name: 'vehicle_plate') String? vehiclePlate,@JsonKey(name: 'vehicle_color') String? vehicleColor,@JsonKey(name: 'vehicle_model') String? vehicleModel,@JsonKey(name: 'vehicle_year') int? vehicleYear,@JsonKey(name: 'vehicle_province') String? vehicleProvince, double balance,@JsonKey(name: 'commission_rate') double commissionRate,@JsonKey(name: 'incentive_tier') String? incentiveTier,@JsonKey(name: 'acceptance_rate') double acceptanceRate,@JsonKey(name: 'cancellation_rate') double cancellationRate,@JsonKey(name: 'weekly_completed_jobs') int weeklyCompletedJobs, String status
});
...
/// Create a copy of DriverProfileEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? userId = null,Object? fullName = null,Object? phone = freezed,Object? rating = null,Object? totalTrips = null,Object? verified = null,Object? documents = null,Object? vehicleTypeIds = null,Object? vehicleTypes = null,Object? vehiclePlate = freezed,Object? vehicleColor = freezed,Object? vehicleModel = freezed,Object? vehicleYear = freezed,Object? vehicleProvince = freezed,Object? balance = null,Object? commissionRate = null,Object? incentiveTier = freezed,Object? acceptanceRate = null,Object? cancellationRate = null,Object? weeklyCompletedJobs = null,Object? status = null,}) {
...
as String?,acceptanceRate: null == acceptanceRate ? _self.acceptanceRate : acceptanceRate // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'full_name')  String fullName,  String? phone,  double rating, @JsonKey(name: 'total_trips')  int totalTrips,  bool verified,  List<DocumentEntity> documents, @JsonKey(name: 'vehicle_type_ids')  List<String> vehicleTypeIds, @JsonKey(name: 'vehicle_types')  List<VehicleTypeEntity> vehicleTypes, @JsonKey(name: 'vehicle_plate')  String? vehiclePlate, @JsonKey(name: 'vehicle_color')  String? vehicleColor, @JsonKey(name: 'vehicle_model')  String? vehicleModel, @JsonKey(name: 'vehicle_year')  int? vehicleYear, @JsonKey(name: 'vehicle_province')  String? vehicleProvince,  double balance, @JsonKey(name: 'commission_rate')  double commissionRate, @JsonKey(name: 'incentive_tier')  String? incentiveTier, @JsonKey(name: 'acceptance_rate')  double acceptanceRate, @JsonKey(name: 'cancellation_rate')  double cancellationRate, @JsonKey(name: 'weekly_completed_jobs')  int weeklyCompletedJobs,  String status)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DriverProfileEntity() when $default != null:
return $default(_that.userId,_that.fullName,_that.phone,_that.rating,_that.totalTrips,_that.verified,_that.documents,_that.vehicleTypeIds,_that.vehicleTypes,_that.vehiclePlate,_that.vehicleColor,_that.vehicleModel,_that.vehicleYear,_that.vehicleProvince,_that.balance,_that.commissionRate,_that.incentiveTier,_that.acceptanceRate,_that.cancellationRate,_that.weeklyCompletedJobs,_that.status);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'full_name')  String fullName,  String? phone,  double rating, @JsonKey(name: 'total_trips')  int totalTrips,  bool verified,  List<DocumentEntity> documents, @JsonKey(name: 'vehicle_type_ids')  List<String> vehicleTypeIds, @JsonKey(name: 'vehicle_types')  List<VehicleTypeEntity> vehicleTypes, @JsonKey(name: 'vehicle_plate')  String? vehiclePlate, @JsonKey(name: 'vehicle_color')  String? vehicleColor, @JsonKey(name: 'vehicle_model')  String? vehicleModel, @JsonKey(name: 'vehicle_year')  int? vehicleYear, @JsonKey(name: 'vehicle_province')  String? vehicleProvince,  double balance, @JsonKey(name: 'commission_rate')  double commissionRate, @JsonKey(name: 'incentive_tier')  String? incentiveTier, @JsonKey(name: 'acceptance_rate')  double acceptanceRate, @JsonKey(name: 'cancellation_rate')  double cancellationRate, @JsonKey(name: 'weekly_completed_jobs')  int weeklyCompletedJobs,  String status)  $default,) {final _that = this;
switch (_that) {
case _DriverProfileEntity():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'user_id')  String userId, @JsonKey(name: 'full_name')  String fullName,  String? phone,  double rating, @JsonKey(name: 'total_trips')  int totalTrips,  bool verified,  List<DocumentEntity> documents, @JsonKey(name: 'vehicle_type_ids')  List<String> vehicleTypeIds, @JsonKey(name: 'vehicle_types')  List<VehicleTypeEntity> vehicleTypes, @JsonKey(name: 'vehicle_plate')  String? vehiclePlate, @JsonKey(name: 'vehicle_color')  String? vehicleColor, @JsonKey(name: 'vehicle_model')  String? vehicleModel, @JsonKey(name: 'vehicle_year')  int? vehicleYear, @JsonKey(name: 'vehicle_province')  String? vehicleProvince,  double balance, @JsonKey(name: 'commission_rate')  double commissionRate, @JsonKey(name: 'incentive_tier')  String? incentiveTier, @JsonKey(name: 'acceptance_rate')  double acceptanceRate, @JsonKey(name: 'cancellation_rate')  double cancellationRate, @JsonKey(name: 'weekly_completed_jobs')  int weeklyCompletedJobs,  String status)?  $default,) {final _that = this;
switch (_that) {
case _DriverProfileEntity() when $default != null:
return $default(_that.userId,_that.fullName,_that.phone,_that.rating,_that.totalTrips,_that.verified,_that.documents,_that.vehicleTypeIds,_that.vehicleTypes,_that.vehiclePlate,_that.vehicleColor,_that.vehicleModel,_that.vehicleYear,_that.vehicleProvince,_that.balance,_that.commissionRate,_that.incentiveTier,_that.acceptanceRate,_that.cancellationRate,_that.weeklyCompletedJobs,_that.status);case _:
  return null;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DriverProfileEntity&&(identical(other.userId, userId) || other.userId == userId)&&(identical(other.fullName, fullName) || other.fullName == fullName)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.rating, rating) || other.rating == rating)&&(identical(other.totalTrips, totalTrips) || other.totalTrips == totalTrips)&&(identical(other.verified, verified) || other.verified == verified)&&const DeepCollectionEquality().equals(other._documents, _documents)&&const DeepCollectionEquality().equals(other._vehicleTypeIds, _vehicleTypeIds)&&const DeepCollectionEquality().equals(other._vehicleTypes, _vehicleTypes)&&(identical(other.vehiclePlate, vehiclePlate) || other.vehiclePlate == vehiclePlate)&&(identical(other.vehicleColor, vehicleColor) || other.vehicleColor == vehicleColor)&&(identical(other.vehicleModel, vehicleModel) || other.vehicleModel == vehicleModel)&&(identical(other.vehicleYear, vehicleYear) || other.vehicleYear == vehicleYear)&&(identical(other.vehicleProvince, vehicleProvince) || other.vehicleProvince == vehicleProvince)&&(identical(other.balance, balance) || other.balance == balance)&&(identical(other.commissionRate, commissionRate) || other.commissionRate == commissionRate)&&(identical(other.incentiveTier, incentiveTier) || other.incentiveTier == incentiveTier)&&(identical(other.acceptanceRate, acceptanceRate) || other.acceptanceRate == acceptanceRate)&&(identical(other.cancellationRate, cancellationRate) || other.cancellationRate == cancellationRate)&&(identical(other.weeklyCompletedJobs, weeklyCompletedJobs) || other.weeklyCompletedJobs == weeklyCompletedJobs)&&(identical(other.status, status) || other.status == status));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,userId,fullName,phone,rating,totalTrips,verified,const DeepCollectionEquality().hash(_documents),const DeepCollectionEquality().hash(_vehicleTypeIds),const DeepCollectionEquality().hash(_vehicleTypes),vehiclePlate,vehicleColor,vehicleModel,vehicleYear,vehicleProvince,balance,commissionRate,incentiveTier,acceptanceRate,cancellationRate,weeklyCompletedJobs,status]);
...
mixin _$DocumentEntity {
 ...
 String get type; String get status;@JsonKey(name: 'media_url') String? get mediaUrl;@JsonKey(name: 'reviewed_at') String? get reviewedAt;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DocumentEntity&&(identical(other.type, type) || other.type == type)&&(identical(other.status, status) || other.status == status)&&(identical(other.mediaUrl, mediaUrl) || other.mediaUrl == mediaUrl)&&(identical(other.reviewedAt, reviewedAt) || other.reviewedAt == reviewedAt));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,type,status,mediaUrl,reviewedAt);

@override
String toString() {
  return 'DocumentEntity(type: $type, status: $status, mediaUrl: $mediaUrl, reviewedAt: $reviewedAt)';
}
...
@useResult
$Res call({
 String type, String status,@JsonKey(name: 'media_url') String? mediaUrl,@JsonKey(name: 'reviewed_at') String? reviewedAt
});
...
/// Create a copy of DocumentEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? type = null,Object? status = null,Object? mediaUrl = freezed,Object? reviewedAt = freezed,}) {
  return _then(_self.copyWith(
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String type,  String status, @JsonKey(name: 'media_url')  String? mediaUrl, @JsonKey(name: 'reviewed_at')  String? reviewedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DocumentEntity() when $default != null:
return $default(_that.type,_that.status,_that.mediaUrl,_that.reviewedAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String type,  String status, @JsonKey(name: 'media_url')  String? mediaUrl, @JsonKey(name: 'reviewed_at')  String? reviewedAt)  $default,) {final _that = this;
switch (_that) {
case _DocumentEntity():
return $default(_that.type,_that.status,_that.mediaUrl,_that.reviewedAt);}
}
/// A variant of `when` that fallback to returning `null`
///
/// It is equivalent to doing:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String type,  String status, @JsonKey(name: 'media_url')  String? mediaUrl, @JsonKey(name: 'reviewed_at')  String? reviewedAt)?  $default,) {final _that = this;
switch (_that) {
case _DocumentEntity() when $default != null:
return $default(_that.type,_that.status,_that.mediaUrl,_that.reviewedAt);case _:
  return null;
...
class _DocumentEntity implements DocumentEntity {
  const _DocumentEntity({required this.type, required this.status, @JsonKey(name: 'media_url') this.mediaUrl, @JsonKey(name: 'reviewed_at') this.reviewedAt});
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _DocumentEntity&&(identical(other.type, type) || other.type == type)&&(identical(other.status, status) || other.status == status)&&(identical(other.mediaUrl, mediaUrl) || other.mediaUrl == mediaUrl)&&(identical(other.reviewedAt, reviewedAt) || other.reviewedAt == reviewedAt));
}
...
/// Create a copy of DocumentEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? type = null,Object? status = null,Object? mediaUrl = freezed,Object? reviewedAt = freezed,}) {
